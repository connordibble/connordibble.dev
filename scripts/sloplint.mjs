 ...
 *
 * Vendored unmodified from the no-slop plugin in
 * https://github.com/connordibble/dibble (plugins/no-slop/skills/writing).
 * The site's copy is linted by the same rules its author distributes.
 */
