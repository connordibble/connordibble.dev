    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          {
            type: "paragraph",
            text: "The first architecture I explored was a retrieval system around the design-system documentation. The idea was straightforward: index the docs, expose a knowledge-base tool to the agent, and let it retrieve relevant chunks before writing code.",
          },
          {
            type: "paragraph",
